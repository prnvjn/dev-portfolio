...
<button className="rounded-xl bg-slate-50 px-5 py-3 text-base  font-medium text-slate-700 transition duration-200 hover:bg-slate-200 active:bg-brand-700"> <HashLink to="/#project" smooth> Project</HashLink>  </button>
</div>
