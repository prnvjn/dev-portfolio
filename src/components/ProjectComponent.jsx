...
const ProjectComponent = ({list,key}) => {
  ...
  return (
    <div key={key} className=" mx-auto grid grid-cols-2 md:gap-16 gap-8 mt-24 items-center">  
        <img className="col-span-2 lg:col-span-1 w-full rounded-2xl shadow" src={list.url} alt="" />
